		...
		<td class="t_ml"></td><td class="t_mm">
			...
			<tr>
				<td valign="top" nowrap width="100%">
					<div style=""><img src="../themes/<?php echo $opinfo["theme"] ?>/info.png" width="14" height="14" border="0" alt=""> Canned responses created here will be available to your account.  They will not be visible to other operators.</div>
