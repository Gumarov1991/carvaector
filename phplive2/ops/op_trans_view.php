<?php
	...
	if ( $opinfo_["pic"] && ( isset( $VALS['PROFILE'] ) && ( $VALS['PROFILE'] == 1 ) ) )
	{
		...
		$profile_pic = "<div id='chat_profile_pic' style='margin-bottom: 5px;'><table cellspacing=0 cellpadding=0 border=0><tr><td valign='top' width='55'><div id='chat_profile_pic_img'><img src='$profile_pic_url' width='55' height='55' border=0 class='profile_pic_img'></div></td><td valign='top' style='padding-left: 15px; min-width: 220px;'><div style=''><div style='font-weight: bold; font-size: 14px;' id='chat_profile_name'>$opinfo_[name]</div><div style='margin-top: 4px;'>$deptinfo[name]</div><div style='margin-top: 4px;' class=''>Chat ID: $ces</div></div></td></tr></table></div>" ;
	}
	$profile_pic .= "<div class='ca'>Visitor ID: $requestinfo[md5_vis]</div>" ;
		...
		<tr>
			...
			<td valign="top">
				...
				<tr>
					...
					<td><div class="chat_info_td_traffic"><?php echo ( $requestinfo["initiated"] ) ? "<img src=\"../themes/$CONF[THEME]/info_initiate.gif\" width=\"10\" height=\"10\" border=\"0\" alt=\"\" title=\"Operator Initiated Chat\" alt=\"Operator Initiated Chat\" style=\"cursor: help;\"> " : "" ; ?><b><?php echo ( $requestinfo["op2op"] ) ? "Operator to Operator Chat" : $opinfo_["name"] ; ?></b> <span style="font-size: 10px;"><?php echo "<a href='mailto:$opinfo_[email]' target='new'>$opinfo_[email]</a>" ?></span></div></td>
				</tr>
				<tr>
...
<div id="table_email" style="display: none; position: absolute; width: 90%; bottom: 10px; padding: 10px; z-Index: 5" class="info_content">
	<form>
	...
	<tr>
		<td colspan=2>Message:<br><textarea class="input_text" rows="7" style="width: 95%; resize: none;" wrap="virtual" id="message">Hi <?php echo $requestinfo["vname"] ?>,
...
[Chat ID: <?php echo $requestinfo["ces"] ?>]
	...
	<tr><td align="center"><input type="button" id="btn_email" value="Email Transcript" onClick="send_email()" class="input_button"> or <a href="JavaScript:void(0)" onClick="toggle_info(0)">cancel</a></td></tr>
	</table>
	</form>
</div>
