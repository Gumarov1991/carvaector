<span style="display: none; padding-left: 10px;" id="span_emoticons"><img src="<?php echo $CONF["BASE_URL"] ?>/addons/emoticons/smile.png" width="16" height="16" border="0" alt="" title="" style="cursor: pointer;" id="chat_emoticons" onClick="toggle_emo_box(0)"></span>
