<?php
	...
	$isop = Util_Format_Sanatize( Util_Format_GetVar( "o" ), "ln" ) ;
	$isop_ = Util_Format_Sanatize( Util_Format_GetVar( "o_" ), "ln" ) ;
	$isop__ = Util_Format_Sanatize( Util_Format_GetVar( "o__" ), "ln" ) ;
	$c_chatting = Util_Format_Sanatize( Util_Format_GetVar( "ch" ), "ln" ) ;
	...
	$realtime = Util_Format_Sanatize( Util_Format_GetVar( "r" ), "ln" ) ;
	$fline = Util_Format_Sanatize( Util_Format_GetVar( "f" ), "ln" ) ;
