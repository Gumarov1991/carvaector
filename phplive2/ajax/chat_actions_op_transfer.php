<?php
	...
	else if ( $action == "transfer" )
	{
		...
		$text = "<idle_pause><div class='ca'>".$LANG["CHAT_TRANSFER"]." <b><top>$opname</top><!--opid:$opid--></b>.<div style='margin-top: 10px;'><div class='ctitle'>".$LANG["TXT_CONNECTING"]."</div></div></div></idle_pause>" ;
