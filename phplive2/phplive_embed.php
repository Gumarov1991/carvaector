	...
	<div id="chat_embed_header" style="width: <?php echo $VARS_CHAT_WIDTH_WIDGET ?>;">
		...
		<tr>
			...
			<td style="width: <?php echo ($VARS_CHAT_WIDTH_WIDGET-90) ?>px;">
				<span id="chat_embed_title" style="white-space: nowrap;"><img src="./themes/<?php echo $theme ?>/lock.png" width="14" height="14" border="0" alt="" id="img_lock" style="display: none;"> <?php echo $LANG["TXT_LIVECHAT"] ?></div>
			</td>
