<?php
	...
	$proto = ( isset( $params[2] ) && $params[2] ) ? Util_Format_Sanatize( rawurldecode( $params[2] ), "n" ) : 0 ;
...
if ( typeof( phplive_widget_embed ) == "undefined" )
{
	...
	<div id='phplive_widget_embed_iframe_shadow' style='display: none; position: fixed; width: <?php echo ( $VARS_CHAT_WIDTH_WIDGET + 23 ) ; ?>px; height: <?php echo ( $VARS_CHAT_HEIGHT_WIDGET + 28 ) ; ?>px; right: 19px; bottom: 0px; z-Index: 40000;'><img src='<?php echo $base_url ?>/themes/initiate/widget_shadow.png' width='<?php echo ( $VARS_CHAT_WIDTH_WIDGET + 23 ) ; ?>' height='<?php echo ( $VARS_CHAT_HEIGHT_WIDGET + 28 ) ; ?>' border='0' alt='' style='width: <?php echo ( $VARS_CHAT_WIDTH_WIDGET + 23 ) ; ?>px !important; height: <?php echo ( $VARS_CHAT_HEIGHT_WIDGET + 28 ) ; ?>px !important;'></div><div id='phplive_widget_embed_iframe_shadow_minimzed' style='display: none; position: fixed; width: 265px; height: 55px; right: 20px; bottom: 0px; z-Index: 40000;'><img src='<?php echo $base_url ?>/themes/initiate/widget_shadow_minimized.png' width='265' height='55' border='0' alt='' style='width: 265px !important; height: 55px !important;'></div>" ;
