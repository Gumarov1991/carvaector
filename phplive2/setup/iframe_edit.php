...
<div id="iframe_body" style="height: 350px;">
	...
	<div id="canned_list" style="overflow: auto;">
		...
		<div style="margin-top: 5px;"><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""> Canned responses created by an operator is only available to the operator for their department(s).</div>
