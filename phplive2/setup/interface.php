				...
				<div style="margin-top: 15px;">
					...
					<tr>
						<td valign="top">
							...
							<div style="margin-top: 15px;"><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""> For proper display of the logo, recommended <b>maximum</b> logo size should be 520 pixels width and 55 pixels height.</div>
