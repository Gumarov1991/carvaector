...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div class="op_submenu_wrapper">
			...
			<!-- <div class="op_submenu" onClick="location.href='interface.php?ses=<?php echo $ses ?>&jump=lang'">Language Text</div> -->
		...
		<div style="margin-top: 25px;" id="div_op_pics">
			...
			<div style="margin-top: 25px;">
				...
				<div style="margin-top: 15px;">
					...
					<div style="margin-top: 15px;"><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""> Profile image size should be 55 pixels width and 55 pixels height.  The image will be automatcially scaled to fit the dimensions.</div>
