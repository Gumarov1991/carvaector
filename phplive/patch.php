		...
		success: function(data){
			...
			if ( json_data.status )
			{
				if ( dev )
				{
					...
					setTimeout( function(){ patch_c += 1 ; auto_patch() ; }, 1000 ) ;
				}
				else
			...
			else
			{
				...
				$('#status').html( percent ) ; $('#loading').fadeTo("fast", 1) ;
				setTimeout( function(){ patch_c += 1 ; auto_patch() ; }, 1100 ) ;
			}
		},
...
<div style="width: 400px; margin: 0 auto; margin-top: 55px; padding: 10px; text-align: center; text-shadow: 1px 1px #FFFFFF;">
	...
	<div style="margin-top: 15px; text-align: center;" class="info_box">Installing and configuring the system.</div>
	<div style="margin-top: 15px;">Just a moment...</div>
</div>
