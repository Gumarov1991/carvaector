			...
			<tr>
				<td valign="top" width="275">
					...
					<div style="margin-top: 15px;" class="info_info">
						...
						<div style="margin-top: 5px;" class="info_neutral">Blink the operator console window for new chat requests.</div>
						<div style="margin-top: 10px;">
					...
					<div style="margin-top: 15px;" class="info_info">
						...
						<div style="margin-top: 5px;" class="info_neutral">Blink the operator console window for new chat responses.</div>
						<div style="margin-top: 10px;">
				...
				<td valign="top" style="padding-left: 50px;">
					...
					<tr id="tr_sound_volume" style="display: none;">
						...
						<td class="td_dept_td_blank" colspan=3><div style="margin-left: 15px;">
							<div>
								<div class="li_op round" style="cursor: pointer;" onClick="update_volume(1)"><input type="radio" name="volume" value="1" onClick="update_volume(this.value)">100%</div>
								<div class="li_op round" style="cursor: pointer;" onClick="update_volume(0.09)"><input type="radio" name="volume" value="0.09" onClick="update_volume(this.value)">75%</div>
								<div class="li_op round" style="cursor: pointer;" onClick="update_volume(0.06)"><input type="radio" name="volume" value="0.06" onClick="update_volume(this.value)">50%</div>
								<div class="li_op round" style="cursor: pointer;" onClick="update_volume(0.03)"><input type="radio" name="volume" value="0.03" onClick="update_volume(this.value)">25%</div>
								<div style="clear: both;"></div>
							</div>
						</div></td>
					</tr>
