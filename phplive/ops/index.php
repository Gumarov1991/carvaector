						...
						<div>
							...
							<tr>
								...
								<td style="padding-left: 15px;">
									<div class="edit_title" style="font-weight: normal;">Logged in as Chat Operator</div>
									<div style="margin-top: 5px;"><?php echo $opinfo["name"] ?> (<?php echo $opinfo["login"] ?>)</div>
