...
<?php include_once( "./inc_header.php" ) ; ?>
		...
		<div id="op_reports" style="display: none; margin: 0 auto;">
			...
			<div style="margin-top: 15px;"><b>Note:</b> If there is an <img src="../pics/icons/online_green.png" width="12" height="12" border="0" alt=""> Online status right after another Online status, it may be because of a setting update (example: theme, sound).  When certain settings are updated, the operator console will need to refresh in order to process the request. The refresh of the operator console will trigger an Online status.</div>
