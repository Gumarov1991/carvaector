...
<div id="canned_wrapper" style="display: none; height: 100%; overflow: auto;">
	...
	<tr>
		<td class="t_ml"></td><td class="t_mm">
			...
			<tr>
				<td width="70%" valign="top"><div id="canned_body" style="height: 300px; overflow-y: auto;"></div></td>
				<td width="30%" valign="top" style="padding-left: 15px;">
					<div id="div_operators" style="height: 300px; overflow-y: auto;">
						<div style="margin-bottom: 10px; font-size: 14px; font-weight: bold;"><img src="../themes/leaves/info_initiate.gif" width="10" height="10" border="0" alt=""> List of Operators</div>
						<?php
							for ( $c = 0; $c < count( $operators ); ++$c )
							{
								...
								$operator_info = "<table cellspacing=0 cellpadding=0 border=0><tr><td><img src=\"$profile_pic_url\" width=\"55\" height=\"55\" border=0 class=\"profile_pic_img\"></td><td style=\"padding-left: 5px;\">$operator[name]$you_indication</td></tr></table>" ;
