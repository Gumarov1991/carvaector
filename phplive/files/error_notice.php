...
<div style="padding: 10px;">
	...
	<div style="margin-top: 25px;">
		<div id="solution_default" style="">
			The live chat software has detected an error.  If you are the website owner, <a href="%solution%" target="new">check for solutions</a> at the <b><font color="3048A1">PHP</font> <font color="#29C029">Live!</font></b> Help Desk.
		</div>
		<div id="solution_mapp" style="display: none;">
			The live chat software has detected an error.  Please notify the Setup Admin of the error.  Once fixed, <a href="JavaScript:void(0)" onClick="do_refresh()">refresh this page</a>.
		</div>
	</div>
