				...
				<?php else: ?>
					<div style="margin-top: 25px;">
						...
						<div id="div_maps_update" style="display: none;">
							<div class="info_info">Google API Key: <input type="text" id="apikey" name="apikey" class="input" size="50" maxlength="55" value="<?php echo ( isset( $CONF["geo"] ) && ( strlen( $CONF["geo"] ) == 39 ) ) ? $CONF["geo"] : "" ; ?>" disabled="disabled"></div>
