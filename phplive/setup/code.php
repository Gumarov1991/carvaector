		...
		<div id="code_main" style="display: none; margin-top: 25px;">
				...
				<tr>
					...
					<td valign="top" style="padding-left: 25px; text-align: justify;" width="50%">
						...
						<div style="margin-top: 5px;" class="info_neutral">
							...
							<div style="margin-top: 5px;"><input type="radio" id="proto_radio_https" name="proto" value="2" <?php echo ( $vars["code"] == 2 ) ? "checked" : "" ?> onClick="toggle_code()"> Always <b><i>HTTPS</i></b> <img src="../pics/icons/lock.png" width="16" height="16" border="0" alt=""> secure chat image and secure chats (SSL enabled servers)</div>
						</div>
						</form>
			...
			<div id="div_html_code" style="margin-top: 25px;">
				...
				<div style="margin-bottom: 25px;">
					...
					<div style="margin-top: 10px;">The above HTML Code will produce the following status icon. <span class="info_neutral"><b>Note:</b> If the chat icon is not displaying, try switching Off the <a href="./icons.php?ses=<?php echo $ses ?>&action=ob">Image Output OB Clean Setting</a>.</span></div>
			...
			<div style="margin-top: 25px;">
				...
				<tr>
					<td valign="top">
						...
						<div class="info_neutral" style="margin-top: 5px;"><img src="../pics/icons/info.png" width="10" height="10" border="0" alt=""> image should be 250x160 pixels</div>
						<div class="info_neutral" style="margin-top: 5px;"><img src="../pics/icons/info.png" width="10" height="10" border="0" alt=""> the "close" (x) portion is part of the image</div>
						<div style="margin-top: 10px;">
