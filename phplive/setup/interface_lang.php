<?php
	...
	if ( $action == "update" )
	{
		...
		if ( ( $LANG["TXT_LIVECHAT"] == $TXT_LIVECHAT ) && ( $LANG["CHAT_WELCOME"] == $TXT_CHAT_WELCOME ) && ( $LANG["CHAT_WELCOME_SUBTEXT"] == $TXT_CHAT_WELCOME_SUBTEXT ) && ( $LANG["TXT_DEPARTMENT"] == $TXT_DEPARTMENT ) && ( $LANG["CHAT_SELECT_DEPT"] == $TXT_CHAT_SELECT_DEPT ) )
		{
								...
								<div style="margin-top: 45px;">
									...
									<div style="margin-top: 5px;">
										...
										<tr>
											...
											<td style="padding-left: 5px;">To update the Leave a Message offline text, access the "Offline Msg" sub menu for each of the  <a href="depts.php?ses=<?php echo $ses ?>">Departments</a> created.</td>
										</tr>
										</table>
									</div>
								</div>
