<?php
	...
	if ( $action == "submit" )
	{
		...
		{
			$error = Ops_put_Op( $dbh, $opid, 1, $mapper, $rate, $sms, $op2op, $traffic, $viewip, $nchats, $maxc, $login, $password, $name, $email ) ;
...
<!--
	...
	function do_edit( theopid, thename, theemail, thelogin, therate, thesms, theop2op, thetraffic, theviewip, themaxc, themapper, thenchats )
	{
		...
		$( "input#mapper_"+themapper ).attr( "checked", true ) ;
		$( "input#nchats_"+thenchats ).attr( "checked", true ) ;
		...
		<div style="display: none;" id="ops_online">
			<div style="margin-top: 25px;">
				...
				<div class="info_info" style="margin-top: 15px;">
					...
					<div style="margin-top: 5px; font-size: 32px; font-weight: bold; text-shadow: 1px 1px #FFFFFF;"><a href="<?php echo ( !preg_match( "/^(http)/", $login_url ) ) ? "http$https:$login_url" : $login_url ; ?>" target="_blank" style="color: #8DB173; text-shadow: 1px 1px #FFFFFF;" class="nounder"><?php echo ( !preg_match( "/^(http)/", $login_url ) ) ? "http$https:$login_url" : $login_url ; ?></a></div>
				</div>
		...
		<div id="div_form" style="display: none; margin-top: 25px;" id="a_edit">
			...
			<div style="margin-top: 15px;">
				...
				<tr>
					...
					<td style="padding-left: 10px;"><input type="text" name="login" id="login" size="30" maxlength="160" value="" onKeyPress="return logins(event)"></td>
				</tr>
				</table>
			</div>
			<div style="margin-top: 15px;">
			...
			<div style="margin-top: 15px;">
				...
				<tr>
					...
					<td style="padding-left: 10px;">
						<table cellspacing=0 cellpadding=0 border=0>
						<tr>
							<td><div class="li_op round"><input type="radio" name="nchats" id="nchats_1" value="1"> Yes</div><div class="li_op round"><input type="radio" name="nchats" id="nchats_0" value="0" checked> No</div><div style="clear:both;"></div></td>
			...
			<div style="margin-top: 15px;">
				...
				<tr>
					...
					<td style="padding-left: 10px;">
						<table cellspacing=0 cellpadding=0 border=0>
						<tr>
							<td><div class="li_op round"><input type="radio" name="mapper" id="mapper_1" value="1"> Yes</div><div class="li_op round"><input type="radio" name="mapper" id="mapper_0" value="0" checked> No</div><div style="clear:both;"></div></td>
