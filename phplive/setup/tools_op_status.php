	...
	<div style="margin-top: 10px;">
		...
		<?php
			for ( $c = 0; $c < count( $operators ); ++$c )
			{
				...
				print "<tr style=\"$tr_style\"><td class=\"td_dept_td\">$operator[name]</td><td class=\"td_dept_td\">$requests</td><td class=\"td_dept_td\" style=\"$style\" $js>$status_img $mapp_online_icon</td></tr>" ;
			}
			if ( $c == 0 )
