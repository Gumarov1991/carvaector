...
function preview_theme( thetheme, thewidth, theheight, thedeptid )
{
	...
	window.open( "../phplive.php?ga=1&d="+thedeptid+"&theme="+thetheme+"&"+unique, "themed"+unique, 'scrollbars=no,resizable=yes,menubar=no,location=no,screenX=50,screenY=100,width='+thewidth+',height='+theheight, thetarget, "location=yes" ) ;
}
