<?php
					...
					$deptvars )
	{
		...
		if ( !isset( $transcript["ces"] ) )
		{
			...
			$query = "INSERT INTO p_transcripts VALUES ( '$ces', $created, $ended, $deptid, $opid, $initiated, $op2op, $rating, 0, $fsize, '$vname', '$vemail', '$ip', '$vis_token', '$question', '$formatted', '$plain' )" ;
			database_mysql_query( $dbh, $query ) ;
